...
export default function HomePage() {
  ...
  return (
    <section className='presentation w-[90%] h-[870px] flex flex-col md:flex-row justify-around xl:justify-center items-center mt-[100px] md:mt-0 overflow-y-hidden'>
