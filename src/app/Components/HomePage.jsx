...
export default function HomePage() {
  ...
  return (
    <section className='presentation w-[90%] md:h-[873px] flex flex-col md:flex-row justify-around xl:justify-center items-center mt-[100px] md:mt-0 overflow-y-hidden text-shadow'>
      ...
      <div data-aos="fade-up" className="image-bg md:block hidden">
        <div className='mt-[50px] xl:mt-[175px]'>
          <Image src="/teste1.png" width={700} height={600} alt="Mulher loira usando óculos"/>
        </div>
      </div>      
    </section>
  );
