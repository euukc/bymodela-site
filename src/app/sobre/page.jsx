...
export default function About() {
    return (
        <main className="h-[500px] flex flex-col-reverse md:flex-row justify-center items-center">
            ...
            <div data-aos="fade-right" className="w-full md:w-[50%] flex justify-center items-center md:items-center flex-col relative md:left-[-350px] md:p-0 px-4 text-[20px] md:text-[35px] mt-[200px] md:mt-[300px] text-justify gap-y-10">
                ...
                <div className="flex gap-x-4">
                    <div className="border-r-4 px-2 text-start">
                        <span className="text-[#7042ccff] md:text-[36px]">1+</span>
                        <p className="text-[12px]">ANOS DE EXPERIÊNCIA</p>
                    </div>
                    <div className="border-r-4 pr-2 text-start">
                        <span className="text-[#7042ccff] md:text-[36px]">650+</span>
                        <p className="text-[12px]">CLIENTES SATISFEITOS</p>
                    </div>
                    <div className="border-r-4 pr-2 text-start">
                        <span className="text-[#7042ccff] md:text-[36px]">100+</span>
                        <p className="text-[12px]">PROJETOS FINALIZADOS</p>
                    </div>
                    <div>
                        <span className="text-[#7042ccff] md:text-[36px]">300+</span>
                        <p className="text-[12px] text-start">PESSOAS DENTRO DA COMUNIDADE NO WHATSAPP</p>
                    </div>
