...
export default function About() {
    return (
        <main className="h-[500px] flex flex-col-reverse md:flex-row justify-center items-center">
            ...
            <div data-aos="fade-right" className="w-full md:w-[50%] flex justify-center items-center md:items-center flex-col relative md:left-[-350px] md:p-0 px-4 text-[20px] md:text-[35px]  md:mt-[300px] text-justify gap-y-10 md:pt-0 pt-[150px]">
